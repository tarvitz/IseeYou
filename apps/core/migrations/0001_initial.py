...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_usersid', (
            ...
            ('expired_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 17, 0, 0))),
    ...
    models = {
        ...
        'core.usersid': {
            ...
            'expired_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
