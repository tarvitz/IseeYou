...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_user', (
            ...
            ('invites', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
        ))
        ...
        db.alter_column(u'accounts_invite', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Invite.sender'
        db.alter_column(u'accounts_invite', 'sender_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        u'accounts.invite': {
            ...
            'expire_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_expired': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_verified': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invite_sender_user_set'", 'null': 'True', 'to': u"orm['accounts.User']"}),
