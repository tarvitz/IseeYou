...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_invite', (
            ...
            ('expire_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 23, 0, 0))),
            ...
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invite_sender_user_set', null=True, to=orm['accounts.User'])),
